...
class GraphQLCodegenModelsForRootTypesTest {
    ...
    private final File outputJavaClassesDir = new File("build/generated/io/github/besi97/graphql/rootmodels");

    @BeforeEach
    void init() {
        mappingConfig.setGenerateModelsForRootTypes(true);
        mappingConfig.setPackageName("io.github.besi97.graphql.rootmodels");
    }
