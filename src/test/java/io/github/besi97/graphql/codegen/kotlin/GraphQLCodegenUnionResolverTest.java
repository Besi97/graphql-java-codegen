...
class GraphQLCodegenUnionResolverTest {
    ...
    void generate_CheckFiles_with_model_package() throws Exception {
        mappingConfig.setPackageName("io.github.besi97.graphql.unionresolver");

        generate();

        File outputJavaClassesDir = new File("build/generated/io/github/besi97/graphql/unionresolver");
