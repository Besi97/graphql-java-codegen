...
class GraphQLCodegenTest {
    ...
    void generate_CustomModelAndApiPackages() throws Exception {
        mappingConfig.setModelPackageName("io.github.besi97.graphql.test1.model");
        mappingConfig.setApiPackageName("io.github.besi97.graphql.test1.api");
        ...
        for (File apiFile : apiFiles) {
            assertThat(Utils.getFileContent(apiFile.getPath()),
                    StringStartsWith.startsWith("package io.github.besi97.graphql.test1.api;"));
        }
        ...
        for (File modelFile : modelFiles) {
            assertThat(Utils.getFileContent(modelFile.getPath()),
                    StringStartsWith.startsWith("package io.github.besi97.graphql.test1.model;"));
        }
    }
