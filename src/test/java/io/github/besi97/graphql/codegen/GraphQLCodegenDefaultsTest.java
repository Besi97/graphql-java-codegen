...
class GraphQLCodegenDefaultsTest {
    ...
    private final File outputJavaClassesDir = new File("build/generated/io/github/besi97/graphql/testdefaults");

    @BeforeEach
    void init() {
        mappingConfig.setPackageName("io.github.besi97.graphql.testdefaults");
    }
